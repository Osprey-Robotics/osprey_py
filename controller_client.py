...
async def send_commands():
	...
	if abs(current_speed_right) > 0:
		...
		UDPClientSocket.sendto(struct.pack('>Bhh', COMMAND_RIGHT_WHEELS, current_speed_right+effective_bonus_speed, current_speed_right+effective_bonus_speed), serverAddressPort)
	if abs(current_speed_left) > 0:
		...
		UDPClientSocket.sendto(struct.pack('>Bhh', COMMAND_LEFT_WHEELS, current_speed_left+effective_bonus_speed, current_speed_left+effective_bonus_speed), serverAddressPort)
	# TODO: Excavation
	# TODO: Deposition
